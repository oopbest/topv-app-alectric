export async function getProducts() {
  // Simulate fetching mock data (in a real app this could be a fetch request to an API)
  const products = [
    {
      id: 1,
    ...
    },
    {
      ...
      stock: 40,
      image: "https://picsum.photos/350/400",
      tags: ["audio", "portable", "electronics"],
    },
    {
      id: 7,
    ...
    },
    {
      ...
      description:
        "Waterproof fitness tracker with heart rate and sleep monitoring.",
      price: 59.99,
      category: "Wearables",
      rating: 5,
      stock: 25,
    ...
    },
    {
      ...
      stock: 70,
      image: "https://picsum.photos/350/400",
      tags: ["health", "personal care", "toothbrush"],
    },
    {
      id: 10,
      name: "Water Bottle",
      description:
        "Insulated stainless steel water bottle with a leak-proof cap.",
      price: 19.99,
      category: "Accessories",
      rating: 4,
      stock: 200,
      image: "https://picsum.photos/350/400",
      tags: ["hydration", "accessories", "outdoors"],
    },
  ];
  return products;
}
