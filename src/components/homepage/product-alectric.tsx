      ...
      <div className="flex flex-col sm:flex-row justify-between pt-6 gap-4">
        <div className="flex-1">
          <div className="flex flex-col gap-4">
            ...
            <h3 className="font-bold">
              Alectric Pet Smart Cat Litter Box ห้องน้ำแมวอัจฉริยะ เชื่อมแอปฯได้
              พร้อมระบบฆ่าเชื้อ รุ่น LB1 - รับประกัน 3 ปี
            </h3>
            <p className="h-24 line-clamp-4 text-gray-500">
              ห้องน้ำแมวอัตโนมัติ Alectric Pet Smart Cat Litter Box
              พร้อมระบบฆ่าเชื้อ ลดกลิ่นที่ไม่พึงประสงค์ภายในบ้าน ทำให้บ้านสะอาด
              ช่วยประหยัดเวลา ให้คุณมีเวลามากขึ้น สามารถ เชื่อมต่อกับ Wi-Fi
        ...
        <div className="flex-1">
          <div className="flex flex-col gap-4">
            ...
            />
            <h3 className="font-bold">
              Alectric Smart Pet Feeder เครื่องให้อาหารอัจฉริยะ มีกล้องพร้อมไมค์
              เชื่อมแอพได้ 5L รุ่น Smart PF1 - รับประกัน 3 ปี
            </h3>
            <p className="h-24 line-clamp-4 text-gray-500">
              ...
              มีฟังก์ชันบันทึกเสียง มีไมค์สื่อสารเรียกสัตว์เลี้ยงได้ในปุ่มเดียว
        ...
        <div className="flex-1">
          <div className="flex flex-col gap-4">
            ...
            <p className="h-24 line-clamp-4 text-gray-500">
              ...
              เพียงพอสำหรับใช้เป็นน้ำดื่มให้กับแมวประมาณ 2-4 วัน วัสดุ ABS เกรด
              A ที่ใช้กับอาหารปลอดภัยและมีสุขภาพที่ดี
...
export default ProductAlectric;
